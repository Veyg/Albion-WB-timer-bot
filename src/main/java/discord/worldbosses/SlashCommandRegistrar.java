                                ...
                                Commands.slash("addtimer", "Add a timer for a world boss")
                                                ...
                                                .addOptions(
                                                                new OptionData(OptionType.STRING, "map",
                                                                                ...
                                                                                .addChoice("Deathwisp Sink",
                                                                                                "Deathwisp Sink")
                                                                                .addChoice("Drownfield Wetland",
                                                                                                "Drownfield Wetland")
                                                                                .addChoice("Dryvein Steppe",
                                                                                                "Dryvein Steppe")
                                                                                .addChoice("Farshore Heath",
                                                                                                "Farshore Heath")
                                                                                .addChoice("Hightree Levee",
                                                                                                "Hightree Levee")
                                                                                .addChoice("Longfen Arms",
                                                                                                "Longfen Arms")
                                                                                .addChoice("Longfen Veins",
                                                                                                "Longfen Veins")
                                                                                .addChoice("Longtimber Glen",
                                                                                                "Longtimber Glen")
                                                                                .addChoice("Rivercopse Fount",
                                                                                                "Rivercopse Fount")
                                                                                .addChoice("Runnelvein Bog",
                                                                                                "Runnelvein Bog")
                                                                                .addChoice("Skysand Ridge",
                                                                                                "Skysand Ridge")
                                                                                .addChoice("Sunfang Cliffs",
                                                                                                "Sunfang Cliffs")
                                                                                .addChoice("Sunfang Dawn",
                                                                                                "Sunfang Dawn")
                                                                                .addChoice("Sunstrand Dunes",
                                                                                                "Sunstrand Dunes")
                                                                                .addChoice("Timberslope Grove",
                                                                                                "Timberslope Grove")
                                                                                .addChoice("Timbertop Dale",
                                                                                                "Timbertop Dale")
                                                                                .addChoice("Watchwood Bluffs",
                                                                                                "Watchwood Bluffs")
                                                                                .addChoice("Westweald Shore",
                                                                                                "Westweald Shore")),
